            ...
            <div class="row">
                <div class="col-md-6 appoinment">
                    <div class="appoinment-box">
                        <div class="heading">
                            <h4>Registrasi</h4>
                            <h2>Harap mengisi data anda dengan lengkap</h2>
                        </div>
                        <form action="{{route('diagnosa.registrasi_store')}}" method="post">
                        @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" id="f-name" name="nama" placeholder="Nama" type="text" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" id="l-lname" name="no_hp" placeholder="No HP" type="text" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control" id="phone" name="alamat" placeholder="Alamat" type="alamat" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" name="submit" id="submit">
                                        Registrasi <i class="fa fa-paper-plane"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
